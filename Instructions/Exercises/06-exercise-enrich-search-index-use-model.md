...
1. حدد **الأساسيات** في **جزء إعداد تدفقات المبيعات**.
   > ملاحظة: إذا قمت بإخفاء جزء **وظيفة إعداد البنية الأساسية لبرنامج ربط العمليات التجارية** من قبل، يمكنك فتحه مرة أخرى عن طريق تحديد **تكوين وإرسال**
...
1. بالنسبة إلى **اسم نقطة النهاية**، أدخل اسمًا فريدًا، على سبيل المثال **car-evaluation-endpoint-1440637584**.
1. بالنسبة إلى **نوع الحوسبة**، حدد **المدارة**.
1. بالنسبة إلى **نوع المصادقة**، حدد **يعتمد على المفتاح**.
...
1. حدد **تكوين** ضمن **الإعدادات**. ثم عليك تعيين **السماح بالوصول المجهول للكائن الثنائي كبير الحجم** إلى **مُمكّن**.
1. حدد **حفظ**.
...
1. ارجع إلى جزء **نظرة عامة** في خدمة البحث الخاصة بك، وحدد **المفهرسون**، ثم حدد **azureblob-indexer**.
...
يجب أن ترى الحقل المملوء `predicted_price`.
